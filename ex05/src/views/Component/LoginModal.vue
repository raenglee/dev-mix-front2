      ...
      <div v-if="isModal" class="modal p-5 w-96 rounded-lg" :class="{ isView: isModal }">
        ...
        <div class="m-5 justify-center">
          <div class="flex flex-col gap-3">
            ...
            <a href="http://login.devmix.store/oauth2/authorization/kakao"><img src="/img/sns_k.png" /></a>
            <a href="http://login.devmix.store/oauth2/authorization/naver"><img src="/img/sns_n.png" /></a>
          </div>
        </div>
