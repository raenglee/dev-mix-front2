      ...
      <div v-if="showModal" class="modal-container" @click.self="closeModal">
        <div class="modal-content">
            ...
            <div>
              ...
              <div class="flex flex-col items-center gap-1">
                ...
                <ul class="mb-1 flex flex-wrap justify-center gap-1">
                  <p v-for="(position) in selectedApplicant.positions" :key="position" class="whitespace-nowrap text-center text-lg mx-2 px-1">
                    {{ position }}
                  </p>
                </ul>
          ...
          <div class="flex justify-center gap-3 mb-4" >
            <button type="button" class="border border-gray-300 bg-gray-300 rounded-full py-1 px-3" @click="reject(currentApplicant.boardId, currentApplicant.positionName, selectedApplicant.nickname)">거절</button>
...
const openModal = async (applicant, userId) => {
  ...
  // 유저 정보를 가져오기
  // userId.value = userId; // userId 업데이트
