      ...
      <div class="flex items-center justify-between w-full">
        ...
        <div class="flex justify-between gap-2 items-center">
          ...
          <!-- <div class="flex flex-col w-full"> -->
            <p class="text-sm font-bold text-gray-700">{{ myApplies.boardTitle }}</p>
            <p class="cursor-pointer text-gray-700 truncate max-w-[500px] whitespace-nowrap overflow-hidden">
...
const openModal = (userId) => {
  myAppliesarr.value = userId; // 클릭한 지원자 정보를 모달에 전달
